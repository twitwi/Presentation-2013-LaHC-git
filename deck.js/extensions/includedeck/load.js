...
function includedeck(m, c) {
    ...
    var info = {
        ...
        "profile-2-noclone": ["@_newdeck", "@_smartsyntax", "@_fit-fs", "@_simplemath", "@_goto", "@_status", "@_navigation", "@_menu", "@_hash", "@_step", "@_events", "@_anim", "@_svg"],
    ...
    head.js.apply(head, toLoad.concat("dummy.js").concat(function() {
        $(function() {
